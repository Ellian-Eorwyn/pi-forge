...
SYSTEM_INSTRUCTIONS = (
    ...
    "Classify from the note in front of you and nothing else. What you know about a subject the "
    "note names is not evidence about this note: a title naming a familiar topic tells you what "
    "the note might be about, never what it is. When the note itself does not settle a property, "
    "that is what needs_review is for. "
