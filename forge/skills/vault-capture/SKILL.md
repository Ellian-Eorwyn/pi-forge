...
| `--lexicon` | the vault's | The speakers-and-terms note, which supplies the glossary and speaker candidates. |
| `--no-lexicon` | off | Disable the glossary and speaker roster for this run. |
