...
- Managed instructions (`AGENTS.md` with its `<project_context>` wrapper): 1552 tokens
- Skills menu (metadata for all skills): 3131 tokens
- **Total forge launch context (always processed): 4683 tokens**
- **Maximum if every `SKILL.md` body is also loaded at once: 35190 tokens**
...
| [`vault-connections`](forge/skills/vault-connections/SKILL.md) | Search an Obsidian vault by meaning, propose links for per-id review, publish completed liter... | 151 | 1608 | 1733 | Model-visible |
