...
- **Maximum if every `SKILL.md` body is also loaded at once: 16627 tokens**
...
| [`organize-folder`](forge/skills/organize-folder/SKILL.md) | Sort a messy folder via a reviewable manifest | 167 | 1168 | 1309 | Model-visible |
